...
예를 들어, 3 * 3의 형태로 카드 들이 다음과 같이 놓여 있다고 가장하자
[[3, 1, 2],
[4, 1, 4],
[2, 2, 2]]
...
def test():
    test1 = number_card([2, 2], [[3, 1], [4, 1]])
    print(test1.check_condition())
    test1.change_condition([3, 3], [[3, 1, 2], [4, 1, 4], [2, 2, 2]])
    print(test1.check_condition())
    assert (test1.calculation() == 2)
    test2 = number_card([2, 3], [[1, 2, 3], [3, 4, 5]])
    print(test2.check_condition())
